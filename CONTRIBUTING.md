...
This document describes the style of commit messages used
by the team. The style we use helps ensure that our commits 
stay small and are easy to browse.
...
```
feat: user creation implemented

Implemented user creation. It's now possible to create users, all of the
checks to make sure that no business rules are violated (*e.g* users without home directory)
are included.
...
This document is based on the [sparkbox/how_to][sparkbox] guide.

[365]: http://365git.tumblr.com/post/3308646748/writing-git-commit-messages
[tpope]: http://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html
[sparkbox]: https://github.com/sparkbox/how_to/blob/d1798456f74ee9cff43f9cf40d01e302ad0e3b7b/style/git/README.md