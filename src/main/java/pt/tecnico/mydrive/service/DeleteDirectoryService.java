...
public class DeleteDirectoryService extends MyDriveService {

    private String fileName;
    private String path;
    private long token;

    public DeleteDirectoryService(long token, String fileName) {
        this.token = token;
    ...
    protected void dispatch() throws MydriveException {
        ...
        Directory directoryfile = (Directory) fs.getFile(fullpathtofile);
        directoryfile.remove();
